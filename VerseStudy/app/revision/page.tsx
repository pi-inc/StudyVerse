...
export default function RevisionPage() {
  ...
  // Replace slider with buttons for difficulty
  const handleDifficultyChange = (value: number) => {
    setDifficulty(value)
    toast({
      title: "Difficulty updated",
      description: `Revision difficulty set to ${value < 33 ? "Easy" : value < 66 ? "Medium" : "Hard"}`,
      className: "bg-gradient-to-r from-study-blue/20 to-study-purple/20 border-study-blue",
    })
  }

  // Replace slider with buttons for daily goal
  const handleDailyGoalChange = (value: number) => {
    setDailyGoal(value)
    toast({
      title: "Daily goal updated",
      description: `You've set a goal to review ${value} items per day`,
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between gap-2">
                    <Button
                      variant={difficulty < 33 ? "default" : "outline"}
                      size="sm"
                      onClick={() => handleDifficultyChange(25)}
                      className="flex-1"
                    >
                      Easy
                    </Button>
                    <Button
                      variant={difficulty >= 33 && difficulty < 66 ? "default" : "outline"}
                      size="sm"
                    ...
                    <Button
                      variant={difficulty >= 66 ? "default" : "outline"}
                      size="sm"
                      onClick={() => handleDifficultyChange(75)}
                      className="flex-1"
                    >
                      Hard
                    </Button>
