          ...
          <div className="space-y-3">
            {filteredTasks.length > 0 ? (
              filteredTasks.map((task) => (
                <Card
                  key={task.id}
                  className={`border ${task.completed ? "bg-muted/50 border-muted" : "bg-card border-border"}`}
                >
                  <CardContent className="p-4">
              ...
              <div className="py-8 text-center">
                <CalendarPlus className="h-10 w-10 text-muted-foreground mx-auto mb-2 opacity-20" />
        ...
        <div>
          ...
          <div className="space-y-3">
            {upcomingDeadlines.map((deadline) => (
              <Card key={deadline.id} className="border-none shadow-sm">
                <CardContent className="p-4">
                  <div className="space-y-3">
