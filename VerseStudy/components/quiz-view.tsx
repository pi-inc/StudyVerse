...
import { CheckCircle, XCircle, ArrowRight, Award, Clock, AlertCircle, Calendar } from "lucide-react"
...
export function QuizView({ topic }: QuizViewProps) {
  ...
  const calculateNextReview = (isCorrect: boolean) => {
    if (isCorrect) return "In 5 days"
    return "Tomorrow"
  }
        ...
        <CardContent className="p-6 flex flex-col items-center justify-center">
          ...
          <div className="text-center mb-6">
            <p className="text-sm text-muted-foreground">
              Based on your performance, these questions will be scheduled for review using spaced repetition.
            </p>
          </div>
      ...
      <CardHeader className="p-4 pb-2 flex flex-row justify-between items-start">
        ...
        <div className="flex flex-col items-end gap-1">
          ...
          <div className="flex items-center gap-1">
            <Calendar className="h-3 w-3 text-study-orange" />
          ...
          >
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs mt-2">Next review: {calculateNextReview(isCorrect)}</p>
              </div>
            </div>
          </motion.div>
        )}
